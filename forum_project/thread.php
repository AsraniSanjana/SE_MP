...
<body>
    ...
    <div class="container my-4">
        <div class="jumbotron">
            ...
            <u><p>Posted by</u> : <em><strong><?php echo $posted_by; ?></strong></em></p>
        </div>
    </div>
    <?php 
    ...
    while($row = mysqli_fetch_assoc($result)){
        ...
        echo '<div class="media my-3">
            ...
            <p class="font-weight-bold my-0"><em class="text-primary">'. $row2['user_email'] .'</em> at <em class="text-success">'. $comment_time. '</em></p> '. $content . '
            </div>
        </div>';
        }
        // echo "this is good";
